                            ...
                            {!loggedIn ? (
                                ...
                                <>
                                    {navItems.map((item) => {
                                        ...
                                        return (
                                            <Link 
                                                key={item.to}
                                                to={item.to} 
                                                className={`flex items-center space-x-2 px-3 py-2 rounded-lg text-sm font-medium tracking-wide transition-all duration-300 ease-in-out transform hover:scale-105 hover:shadow-md ${
                                                    scrolled 
                                                        ? 'text-gray-700 hover:text-blue-600 hover:bg-blue-50 hover:shadow-blue-100' 
                                                        : 'text-blue-100 hover:text-white hover:bg-white/20 hover:shadow-white/20'
                                                }`}
                                    ...
                                    <button 
                                        ...
                                        className={`flex items-center space-x-2 px-4 py-2 rounded-lg text-sm font-medium border-2 transition-all duration-300 ease-in-out transform hover:scale-105 ${
                                            scrolled 
                    ...
                    {!loggedIn ? (
                        ...
                        <>
                            {navItems.map((item) => {
                                ...
                                return (
                                    <Link 
                                        key={item.to}
                                        to={item.to} 
                                        className={`flex items-center space-x-3 px-3 py-2 rounded-lg text-base font-medium transition-all duration-300 ease-in-out hover:translate-x-2 ${
                                            scrolled 
                                                ? 'text-gray-700 hover:text-blue-600 hover:bg-blue-50' 
                                                : 'text-white hover:bg-white/20'
                                        }`}
                            ...
                            <button 
                                ...
                                className={`flex items-center space-x-3 w-full text-left px-3 py-2 rounded-lg text-base font-medium transition-all duration-300 ease-in-out hover:translate-x-2 ${
                                    scrolled 
